...
namespace DiamondShop.BusinessLogic.Interfaces
{
    public interface IOrderDetailService
    {
        ...
        public Task<List<OrderDetail>> GetList_OrderDetail_By_OrderId(Guid orderId);
        public Task<PagedResult<OrderDetail>> GetList_OrderDetail_By_Filter(OrderDetail_PagingDto filters);
