...
--InCart
	...
	('ord00009', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'diem.le@gmail.com')),
	('ord00010', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'tuan.ngo@gmail.com')),
	('ord00011', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'duc.do@gmail.com')),
	('ord00012', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'van.truong@gmail.com')),
	('ord00013', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'hai.ngo@gmail.com')),
	('ord00014', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'bao.hoang@gmail.com')),
	('ord00015', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'thuy.pham@gmail.com')),
	('ord00016', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'an.nguyen@gmail.com')),
	('ord00017', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'tuan.le@gmail.com')),
	('ord00018', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'bao.tran@gmail.com')),
	('ord00019', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'hong.le@gmail.com')),
	('ord00020', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'ha.tran@gmail.com')),
	('ord00021', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'minh.do@gmail.com')),
	('ord00022', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'danh.trinh@gmail.com')),
	('ord00023', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'minh.le@gmail.com')),
	('ord00024', 'InCart', (select cus.Id from [Customer] cus join Account acc on cus.AccountId = acc.Id where acc.Email = 'my.nguyen@gmail.com')),
...
--Clavia Rings
	insert into [Picture](UrlPath, DiamondId, ProductId) select 'https://firebasestorage.googleapis.com/v0/b/diamondshop-253ae.appspot.com/o/Clavia_Preview.png?alt=media', null, [Product].Id from [Product] where [Product].[Type]='Ring' and [Product].[Name] like '%Clavia%';
	go
	insert into [Picture](UrlPath, DiamondId, ProductId) select 'https://firebasestorage.googleapis.com/v0/b/diamondshop-253ae.appspot.com/o/Clavia_Stand.png?alt=media', null, [Product].Id from [Product] where [Product].[Type]='Ring' and [Product].[Name] like '%Clavia%';
	go
	insert into [Picture](UrlPath, DiamondId, ProductId) select 'https://firebasestorage.googleapis.com/v0/b/diamondshop-253ae.appspot.com/o/Clavia_Lay.png?alt=media', null, [Product].Id from [Product] where [Product].[Type]='Ring' and [Product].[Name] like '%Clavia%';
	go
